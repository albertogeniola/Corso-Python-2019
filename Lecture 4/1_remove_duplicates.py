"""
Given a list of elements, remove all the duplicates and print all the elements in a sorted manner
...
data = [48, 0, 10, 22, 5, 37, 22, 50, 19, 32, 42, 21, 5, 4, 16, 44, 42, 21, 7, 28, 43, 47, 33, 13, 8, 50, 29, 35, 12,
...
# Attempt 1: CPU-Iterative way

# Attempt 2: Using another data structure as helper

# Attempt 3: Quickest way
